                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('login') }}" class="pt-4">
                                ...
                                <div class="input-box">
                                    <label class="label-text" for="email">Email or Username</label>
                                ...
                                <div class="input-box">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input
                                            class="form-control form--control password-field @error('email')
                                            is-invalid
                                        @enderror"
                                ...
                                <div class="btn-box">
                                    ...
                                    <button class="btn theme-btn" type="submit">Login Account
                                        <i class="la la-arrow-right icon ml-1"></i>
                                    </button>
                                    <p class="fs-14 pt-2">Don't have an account?
